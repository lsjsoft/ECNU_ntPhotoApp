...
/** \addtogroup Initialization */ //@{
	...
	bool	CreateFromArray(BYTE* pArray,DWORD dwWidth,DWORD dwHeight,DWORD dwBitsperpixel, DWORD dwBytesperline, bool bFlipImage, bool bFlipAlpha);
...
/** \addtogroup Alpha */ //@{
	...
	BYTE* GetAlphaData() { return pAlpha;	}
//@}
